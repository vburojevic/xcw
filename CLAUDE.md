...
bd create --type task --priority P2 --title "Short title" --description "What/why + acceptance criteria"

# Start work / add progress notes
bd update <issue-id> --status in_progress
bd comment <issue-id> "Progress update + verification commands (e.g. go test ./...)"
